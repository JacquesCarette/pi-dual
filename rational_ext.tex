...
{{[^b^]=0}} (see Defn. \ref{def:size} and \ref{def:size-frac}
below). This eliminates syntaxes of the form {{1/0}}, {{1/(0+0)}},
...
\begin{proof}
  ...
  hold. The second combinator simply mirrors {{c}}. To show that
  {{c=id}}, we must show for {{v:b}}, the evaluation of {{<c, v, []>}}
  always produces {{v:b}} as output.
