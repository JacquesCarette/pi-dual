...
\begin{abstract}
  ...
  with the isomorphisms of finite types, {{Pi}}. Given the
  first-order nature of {{Pi}} however it was unclear how one may
  express first-class functions and duality in the sense of Filinski.

  We present a computational model whose types are \emph{the field of
    rational numbers}. This computational model is derived
  systemmatically from the {{Pi}} by considering a symmetric
  notion of duality. Unlike the \lcal which shows a classical demorgan
  duality, here we have two axis of dualization and hence two
...
Andrzej Filinksi's masters thesis
...
\begin{proposition}[Correspondence]
  Evalution in the small-step evaulator corresponds to evaluation in
...
For a traced symmetric monoidal catgeory, the Int-construction of
...
Provide a semantics with the nondeterminism monad and define an
\emph{eval}.
...
structure of finite dimensionl hilbert spaces with unitary maps and
...
accomodate proabailities etc in this setting and this is all
meaningless or (2) constrcutions in {{PiEE*}} correspond to physical
phenomena.
