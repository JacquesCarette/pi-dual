...
In order to interpret fractional types, we define a monad {{S}} over the
{{Pi}}-category of finite sets and bijections. The functor part of the monad
\[\begin{array}{rcl}
...
\paragraph*{Data.} We extend values types with types {{S b}} denoting sets of
values {{ {| v1, v2, dots |} }}:
%subcode{bnf} include main
