...
\end{proposition}
\begin{proof}
  For convenience let us draw {{swap* (;) eps*}} shown on the left
  instead as shown on the right.
...
The two coherence conditions are more intuitive when presented
...
a functor specifically because divsion is not defined on 0 sized
types. 
