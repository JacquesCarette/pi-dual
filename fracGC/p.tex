...
There are two main reasons we are calling the new type constructor a
\emph{fractional type} and using the suggestive notation
$\oneover{t}$:
\begin{itemize}
\item Categorical: ... explain and point to section with examples
  showing 1/ab = 1/a  1/b etc.
\item Operational ... this section; bits = log of size; fractional
  needs negative bits; i.e. space collector; make this precise  
\end{itemize}
