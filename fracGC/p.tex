...
since scope is a \emhp{static property} of programs, it does
...
the values is \AgdaInductiveConstructor{false} or \AgdaInductiveConstructor{true}. The prepending list
