...
principle characterizes quantum computing and its classical
restriction known as reversible computing.

\paragraph*{Quantum (Reversible) Computing.} The quantum circuit model
can be characterized as a classical reversible circuit model augmented
with parallel operations modeling superpositions. Computations in the
classical submodel can be formalized as isomorphisms on finite types,
i.e., the types generated from the empty type 0, the unit type 1, and
sums and products. Put differently, the principle of conservation of
information is expressed as computating via sound and complete type
isomorphisms~\cite{James:2012:IE:2103656.2103667} or type
equivalences~\cite{DBLP:conf/esop/CaretteS16}.
