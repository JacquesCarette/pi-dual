...
reviewed in Sec.~\ref{sec:examples}, current proposals for reversible
and quantum programming languages
(e.g. Quipper~\cite{Green:2013:QSQ:2491956.2462177}), this safety
condition is at the programmer's discretion whereas. 
