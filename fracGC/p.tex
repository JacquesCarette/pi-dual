...
of replacing the cumbersome evidence that the type is not empty by the
more intuitive evidence of choosing a value of the type. The
simplications are evident in the Agda formalization:
...
Example Sec. 3.2 of
\url{https://people.engr.ncsu.edu/hzhou/quantum_assert.pdf} with ancilla
initialized to 1 to detected entanglement
