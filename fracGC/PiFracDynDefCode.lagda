...
rev× {A} {B} {A≠0} {B≠0} =
    𝟙/ (A ×ᵤ B)
  ↔⟨ uniti⋆l ⊚ uniti⋆l ⊚ assocl⋆ ⟩ (𝟙 ×ᵤ 𝟙) ×ᵤ 𝟙/ (A ×ᵤ B)
  ↔⟨ (η {A} {A≠0} ⊗ η {B} {B≠0}) ⊗ id↔ ⟩ ((A ×ᵤ (𝟙/ A)) ×ᵤ (B ×ᵤ (𝟙/ B))) ×ᵤ (𝟙/ (A ×ᵤ B))
  ↔⟨ (shuffle ⊗ id↔) ⊚ assocr⋆  ⟩ ((𝟙/ A) ×ᵤ (𝟙/ B)) ×ᵤ ((A ×ᵤ B) ×ᵤ (𝟙/ (A ×ᵤ B)))
  ↔⟨ id↔ ⊗ (ε {A ×ᵤ B} {pr≠0 A B A≠0 B≠0}) ⟩ ((𝟙/ A) ×ᵤ (𝟙/ B)) ×ᵤ 𝟙
  ↔⟨ unite⋆r ⟩ (𝟙/ A) ×ᵤ (𝟙/ B) □
