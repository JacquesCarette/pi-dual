...
xxx' = (mkTransposition zero zero) ∷
      ...
      (mkTransposition (inject+ 30 (fromℕ 4)) (inject+ 6 (fromℕ 28))) ∷
      (mkTransposition (inject+ 33 (fromℕ 1)) (inject+ 29 (fromℕ 5))) ∷
      (mkTransposition (inject+ 28 (fromℕ 6)) (inject+ 26 (fromℕ 8))) ∷
      (mkTransposition (inject+ 27 (fromℕ 7)) (inject+ 19 (fromℕ 15))) ∷ 
      (mkTransposition (inject+ 26 (fromℕ 8)) (inject+ 12 (fromℕ 22))) ∷
      (mkTransposition (inject+ 25 (fromℕ 9)) (inject+ 5 (fromℕ 29))) ∷
      (mkTransposition (inject+ 32 (fromℕ 2)) (inject+ 24 (fromℕ 10))) ∷
      (mkTransposition (inject+ 23 (fromℕ 11)) (inject+ 25 (fromℕ 9))) ∷
      (mkTransposition (inject+ 22 (fromℕ 12)) (inject+ 18 (fromℕ 16))) ∷ 
      (mkTransposition (inject+ 21 (fromℕ 13)) (inject+ 11 (fromℕ 23))) ∷ 
      (mkTransposition (inject+ 20 (fromℕ 14)) (inject+ 4 (fromℕ 30))) ∷ 
      (mkTransposition (inject+ 19 (fromℕ 15)) (inject+ 31 (fromℕ 3))) ∷ 
      (mkTransposition (inject+ 18 (fromℕ 16)) (inject+ 24 (fromℕ 10))) ∷ 
      (mkTransposition (inject+ 17 (fromℕ 17)) (inject+ 17 (fromℕ 17))) ∷ 
      (mkTransposition (inject+ 16 (fromℕ 18)) (inject+ 10 (fromℕ 24))) ∷ 
      (mkTransposition (inject+ 15 (fromℕ 19)) (inject+ 3 (fromℕ 31))) ∷ 
      (mkTransposition (inject+ 14 (fromℕ 20)) (inject+ 30 (fromℕ 4))) ∷ 
      (mkTransposition (inject+ 13 (fromℕ 21)) (inject+ 23 (fromℕ 11))) ∷ 
      (mkTransposition (inject+ 12 (fromℕ 22)) (inject+ 16 (fromℕ 18))) ∷ 
      (mkTransposition (inject+ 11 (fromℕ 23)) (inject+ 9 (fromℕ 25))) ∷ 
      (mkTransposition (inject+ 10 (fromℕ 24)) (inject+ 2 (fromℕ 32))) ∷ 
      (mkTransposition (inject+ 9 (fromℕ 25)) (inject+ 29 (fromℕ 5))) ∷ 
      (mkTransposition (inject+ 8 (fromℕ 26)) (inject+ 22 (fromℕ 12))) ∷ 
      (mkTransposition (inject+ 7 (fromℕ 27)) (inject+ 15 (fromℕ 19))) ∷ 
      (mkTransposition (inject+ 6 (fromℕ 28)) (inject+ 8 (fromℕ 26))) ∷ 
      (mkTransposition (inject+ 5 (fromℕ 29)) (inject+ 1 (fromℕ 33))) ∷ 
      (mkTransposition (inject+ 4 (fromℕ 30)) (inject+ 28 (fromℕ 6))) ∷ 
      (mkTransposition (inject+ 3 (fromℕ 31)) (inject+ 21 (fromℕ 13))) ∷ 
      (mkTransposition (inject+ 2 (fromℕ 32)) (inject+ 14 (fromℕ 20))) ∷ 
      (mkTransposition (inject+ 1 (fromℕ 33)) (inject+ 7 (fromℕ 27))) ∷ 
      (mkTransposition (inject+ 0 (fromℕ 34)) (inject+ 0 (fromℕ 34))) ∷ []

vs : Vec (ℕ × ℕ) 35 -- 7 * 5
vs = (0 , 0) ∷ (0 , 1) ∷ (0 , 2) ∷ (0 , 3) ∷ (0 , 4) ∷ 
     (1 , 0) ∷ (1 , 1) ∷ (1 , 2) ∷ (1 , 3) ∷ (1 , 4) ∷ 
     (2 , 0) ∷ (2 , 1) ∷ (2 , 2) ∷ (2 , 3) ∷ (2 , 4) ∷ 
     (3 , 0) ∷ (3 , 1) ∷ (3 , 2) ∷ (3 , 3) ∷ (3 , 4) ∷ 
     (4 , 0) ∷ (4 , 1) ∷ (4 , 2) ∷ (4 , 3) ∷ (4 , 4) ∷ 
...
-- T vs ws 
-- 
-- 0*n+0      0*n+1       0*n+2      0*n+3       0*n+4
-- (0 , 10) ∷ (0 , 11) ∷ (0 , 12) ∷ (0 , 13) ∷ (0 , 14) ∷ 
-- 
-- 1*n+0      1*n+1       1*n+2      1*n+3       1*n+4
-- (1 , 10) ∷ (1 , 11) ∷ (1 , 12) ∷ (1 , 13) ∷ (1 , 14) ∷
-- 
-- 2*n+0      2*n+1       2*n+2      2*n+3       2*n+4
-- (2 , 10) ∷ (2 , 11) ∷ (2 , 12) ∷ (2 , 13) ∷ (2 , 14) ∷
-- 
-- 3*n+0      3*n+1       3*n+2      3*n+3       3*n+4
-- (3 , 10) ∷ (3 , 11) ∷ (3 , 12) ∷ (3 , 13) ∷ (3 , 14) ∷
-- 
-- 4*n+0      4*n+1       4*n+2      4*n+3       4*n+4
-- (4 , 10) ∷ (4 , 11) ∷ (4 , 12) ∷ (4 , 13) ∷ (4 , 14) ∷
-- 
-- 5*n+0      5*n+1       5*n+2      5*n+3       5*n+4
-- (5 , 10) ∷ (5 , 11) ∷ (5 , 12) ∷ (5 , 13) ∷ (5 , 14) ∷
-- 
-- 6*n+0      6*n+1       6*n+2      6*n+3       6*n+4
...
-- 0*n+0      0*n+1       0*n+2      0*n+3       0*n+4
-- (0 , 10) ∷ (1 , 12) ∷ (0 , 12) ∷ (0 , 13) ∷ (0 , 14) ∷ 
-- 
-- 1*n+0      1*n+1       1*n+2      1*n+3       1*n+4
-- (1 , 10) ∷ (1 , 11) ∷ (0 , 11) ∷ (1 , 13) ∷ (1 , 14) ∷
-- 
-- 2*n+0      2*n+1       2*n+2      2*n+3       2*n+4
-- (2 , 10) ∷ (2 , 11) ∷ (2 , 12) ∷ (2 , 13) ∷ (2 , 14) ∷
-- 
...
-- 0*n+0      0*n+1       0*n+2      0*n+3       0*n+4
-- (0 , 10) ∷ (1 , 12) ∷ (2 , 14) ∷ (0 , 13) ∷ (0 , 14) ∷ 
-- 
-- 1*n+0      1*n+1       1*n+2      1*n+3       1*n+4
-- (1 , 10) ∷ (1 , 11) ∷ (0 , 11) ∷ (1 , 13) ∷ (1 , 14) ∷
-- 
-- 2*n+0      2*n+1       2*n+2      2*n+3       2*n+4
-- (2 , 10) ∷ (2 , 11) ∷ (2 , 12) ∷ (2 , 13) ∷ (0 , 12) ∷
-- 
-- 3*n+0      3*n+1       3*n+2      3*n+3       3*n+4
-- (3 , 10) ∷ (3 , 11) ∷ (3 , 12) ∷ (3 , 13) ∷ (3 , 14) ∷
-- 
...
-- 0*n+0      0*n+1       0*n+2      0*n+3       0*n+4
-- (0 , 10) ∷ (1 , 10) ∷ (2 , 14) ∷ (4 , 11) ∷ (5 , 13) ∷ 
-- 
-- 1*n+0      1*n+1       1*n+2      1*n+3       1*n+4
-- (1 , 12) ∷ (1 , 11) ∷ (0 , 11) ∷ (1 , 13) ∷ (1 , 14) ∷
-- 
-- 2*n+0      2*n+1       2*n+2      2*n+3       2*n+4
-- (2 , 10) ∷ (2 , 11) ∷ (2 , 12) ∷ (2 , 13) ∷ (0 , 12) ∷
-- 
...
-- 
-- 1*n+0      1*n+1       1*n+2      1*n+3       1*n+4
-- (1 , 12) ∷ (1 , 13) ∷  (3 , 10) ∷ (1 , 11) ∷ (1 , 14) ∷
-- 
-- 2*n+0      2*n+1       2*n+2      2*n+3       2*n+4
-- (2 , 10) ∷ (2 , 11) ∷ (2 , 12) ∷ (2 , 13) ∷ (0 , 12) ∷
-- 
-- 3*n+0      3*n+1       3*n+2      3*n+3       3*n+4
-- (0 , 11) ∷ (3 , 11) ∷ (3 , 12) ∷ (3 , 13) ∷ (3 , 14) ∷
-- 
-- 4*n+0      4*n+1       4*n+2      4*n+3       4*n+4
-- (4 , 10) ∷ (0 , 13) ∷ (4 , 12) ∷ (4 , 13) ∷ (4 , 14) ∷
-- 
...
-- 0*n+0      0*n+1       0*n+2      0*n+3       0*n+4
-- (0 , 10) ∷ (1 , 10) ∷ (2 , 10) ∷ (4 , 11) ∷ (5 , 13) ∷ 
-- 
-- 1*n+0      1*n+1       1*n+2      1*n+3       1*n+4
-- (1 , 12) ∷ (1 , 13) ∷  (3 , 10) ∷ (4 , 12) ∷ (5 , 14) ∷
-- 
-- 2*n+0      2*n+1       2*n+2      2*n+3       2*n+4
-- (2 , 14) ∷ (2 , 11) ∷ (2 , 12) ∷ (2 , 13) ∷ (0 , 12) ∷
-- 
-- 3*n+0      3*n+1       3*n+2      3*n+3       3*n+4
-- (0 , 11) ∷ (3 , 11) ∷ (3 , 12) ∷ (3 , 13) ∷ (3 , 14) ∷
-- 
...
-- 
-- 1*n+0      1*n+1      1*n+2       1*n+3      1*n+4      
-- (10 , 5) ∷ (10 , 6) ∷ (11 , 0) ∷ (11 , 1) ∷ (11 , 2) ∷ 
-- 
-- 2*n+0      2*n+1      2*n+2       2*n+3      2*n+4     
-- (11 , 3) ∷ (11 , 4) ∷ (11 , 5) ∷ (11 , 6) ∷ (12 , 0) ∷ 
-- 
-- 3*n+0      3*n+1      3*n+2      3*n+3      3*n+4      
-- (12 , 1) ∷ (12 , 2) ∷ (12 , 3) ∷ (12 , 4) ∷ (12 , 5) ∷ 
--
-- 4*n+0      4*n+1       4*n+2      4*n+3      4*n+4      
-- (12 , 6) ∷ (13 , 0) ∷ (13 , 1) ∷ (13 , 2) ∷ (13 , 3) ∷ 
-- 
-- 5*n+0      5*n+1      5*n+2       5*n+3       5*n+4      
-- (13 , 4) ∷ (13 , 5) ∷ (13 , 6) ∷ (14 , 0) ∷ (14 , 1) ∷ 
-- 
-- 6*n+0      6*n+1      6*n+2      6*n+3      6*n+4
