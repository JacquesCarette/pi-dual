...
evalComb Id m = m
evalComb (Sym c) m = undefined -- write evalCombB etc.
evalComb (c1 :.: c2) m = evalComb c2 (evalComb c1 m)
-- c1 : t1 -> t2
-- c2 : t3 -> t4
-- m : t1 * t3
-- produce t2 * t4
evalComb (c1 :*: c2) (PPL m) = PPL (evalComb c1 m)
evalComb (c1 :*: c2) (PPR m) = PPR (evalComb c2 m)
evalComb (c1 :*: c2) (PPBoth m1 m2) = PPBoth (evalComb c1 m1) (evalComb c2 m2)
evalComb (c1 :*: c2) (MML m) = undefined
evalComb (c1 :*: c2) (MMR m) = undefined
evalComb (c1 :*: c2) (MMBoth m1 m2) = undefined
evalComb (c1 :*: c2) (PML m) = undefined
evalComb (c1 :*: c2) (PMR m) = undefined
evalComb (c1 :*: c2) (PMBoth m1 m2) = undefined
evalComb (c1 :*: c2) (MPL m) = undefined
evalComb (c1 :*: c2) (MPR m) = undefined
evalComb (c1 :*: c2) (MPBoth m1 m2) = undefined
...
evalComb CommuteTimes (PPL m) = PPR m
evalComb CommuteTimes (PPR m) = PPL m
evalComb CommuteTimes (PPBoth m1 m2) = PPBoth m2 m1
evalComb CommuteTimes (MML m) = MMR m
evalComb CommuteTimes (MMR m) = MML m
evalComb CommuteTimes (MMBoth m1 m2) = MMBoth m2 m1
evalComb CommuteTimes (PML m) = MPR m
evalComb CommuteTimes (PMR m) = MPL m
evalComb CommuteTimes (PMBoth m1 m2) = MPBoth m2 m1
evalComb CommuteTimes (MPL m) = PMR m
evalComb CommuteTimes (MPR m) = PML m
evalComb CommuteTimes (MPBoth m1 m2) = PMBoth m2 m1
