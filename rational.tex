...
independent of each other and we could chosen to evaluate either
...
to run backwards `{{<--|}}', thereby computing the start state from
the stop state. We will take advantage of this property in
Sec. \ref{sec:rat}.
