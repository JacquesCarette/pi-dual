...
Since the monoidal units cxan be freely introduced and eliminated, in
many diagrams they are omitted and dealt with explicitely when they
...
in the precense of fractionals. Hence an {{eta* : 1 <-> inv(b) * b}} is
...
of type {{inv(b)}}. These two values are free to move independantly
...
% {[c1, v, Fst cc c2]} &|-->& <c2, v, Snd c1 cc>
% {[c2, v, Snd c1 cc]} &|-->& {[ c1(;)c2, v, cc ]}
% <c1(+)c2, v' <><> L v, cc> &|-->& <c1, v, LeftPlus cc c2>
% {[ c1, v, LeftPlus cc c2 ]} &|-->& {[c1 (+) c2, L v, cc ]}
% <c1(+)c2, v' <><> R v, cc> &|-->& <c2, v, RightPlus c1 cc>
% {[ c2, v, RightPlus c1 cc ]} &|-->& {[c1 (+) c2, R v, cc ]}
% <c1(*)c2, v' <><> (v1, v2), cc> &|-->& <c1, v1, LeftTimes cc c2 v2>
% {[ c1, v1, LeftTimes cc c2 v2 ]} &|-->& <c2, v2, RightTimes c1 v1 cc>
% {[ c2, v2, RightTimes c1 v1 cc ]} &|-->& {[ c1 (*) c2, (v1, v2), cc ]}
