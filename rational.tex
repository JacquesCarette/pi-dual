...
%%%%%%%%%%%%%%%%%%
\subsection{Constructions in {{langRevEE}} specific to Addition and Multiplication}
...
These functions aren't really values. There is no value one can
...
product encoding of environments, there is no value one can assign to
a variable such that it denotes a function.
