...
%subcode{opsem} include main
% D[P|(left v) c1 (+) c2| F] &|-->& D:(P|[](+)c2|F)[ []| v c1| [] ]
% D[P| (right v) c1 (+) c2| F] &|-->& D:(P|c1(+)[]|F)[ []| v c2| [] ]
% D:(P|[](+)c2|F)[P'|c1 v| [] ]  &|-->& D[P|(P'(c1)(+)c2{dagger}) (left v)| F] 
% D:(P|c1(+)[]|F)[P'| c2 v| [] ] &|-->& D[P|(c1{dagger}(+)P'(c2)) (right v)| F]
...
%subcode{opsem} include main
% D[P| (right v) eps| F]      &|-->&  D{dagger}[F | eps (left (-v))| P]
% D[P| (left (-v)) eps| F]      &|-->&  D{dagger}[F | eps (right v)| P]
