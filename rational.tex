...
with {{eta+}}/{{eps+}}, we get the following definition. 
Given {{f : a+c <-> b+c }}, define {{trace+ f : a <-> b}} as:

{{ trace+ f = zeroi (;) (id (+) eta+) (;) (f (+) id) (;) (id (+) eps+) (;) zeroe }} 

For readability, we have omitted some the commutativity and
associativity shuffling.
