...
entangled values, {{1/x}} and {{x}}, such that specifying one
implicitly specifies the dependant other. These three subcomputations
exist \emph{at the same time}. At line (3), the dependant {{1/x}} is
fixed to be the value {{20}}, thereby making fixing values of all
three branches.
