...
\pause
  \begin{center}
    \red{Can we implement {{Pi0}} in hardware? }
  \end{center}

\end{frame}

% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Challenge : Thoughts}
...
\item What is {{Pi0}}? 
  \begin{itemize}
  \item Lots of wires... and shuffling
  \item Distribute/Factor = Mux/Demux -- i.e. no transistors. 
  \item Trace = Feedback loops
  \end{itemize}

\vfill
\item Types? 
  \begin{itemize}
  \item Information carrying content of wires
  \item Some sort of ``fidelity''
  \end{itemize}
...
\item SQUIDs
  \begin{itemize}
  \item 2-3 degrees Kelvin we get superconductivity 
  \item Chips for satellites
  \end{itemize}

\vfill
\item We don't know much about hardware
  \begin{itemize}
  \item But we'd be excited to collborate
  \end{itemize}
