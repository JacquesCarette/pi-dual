...
vector spaces (more refined because it doesn't collpase 1/b to b; also each
...
a potentionally better and more semantics is based on groupoids; mention that
we can have sets (with stucture) who cardinality is fractionals and that this
