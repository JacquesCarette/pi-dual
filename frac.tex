...
In the physics community, Landauer~\cite{Landauer:1961}, Feynman, and 
others have interpreted the laws of
...
witnesses, explains, and models the process of transforming one observable
to the other. 
...
Note that a small modification of {{lanRev}} (the addition of an
...
but would correspond to certain identity types being trivial.  {{lanRev}}
instead, at the type leve, models a commutative ringoid where the
...
and positive information. Symmetrically, the combinator {{eps*_b : 1/b * b <->
1}} matches up an equal amount of negative and positive information producing 
no residual information.  The best analogy is probably that of vectors and
covectors, also know as column vectors and row vectors (respectively): in
