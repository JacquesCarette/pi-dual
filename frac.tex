...
and bijections: each type denotes a finite set of the corresponding size and
...
\label{def:langRevT}
We extend Def.~\ref{def:Pi} as follows:
%subcode{bnf} include main
% value types, b ::= ... | 1/b
% values, v ::= ... | 1/v
%
...
matches up an equal amount of negative and positive information producing 
